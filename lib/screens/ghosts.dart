...
List<Ghost> ghostEntries = [
  Ghost(
    ...
    description: "The White Lady or Kaperosa of Balete Drive is a spectral figure said to be haunting the two-lane street of Balete Drive in New Manila, Quezon City, Philippines. \n\n" 
    ...
    lightImagePath: "assets/ghost/whitelady_light.png", 
    darkImagePath: "assets/ghost/whitelady_dark.png",
    lightNamePath: "assets/ghost/whiteladyname_light.png", 
    darkNamePath: "assets/ghost/whiteladyname_dark.png",
    lightPageCountPath: "assets/ghost/Gpagecount1_light.png",
    darkPageCountPath: "assets/ghost/Gpagecount1_dark.png",
    sources: [
  ...
  Ghost(
    ...
    description: "The Diplomat Hotel was a serene retreat built by the Dominican Order as a place for spiritual reflection back in 1913. Officially called the Dominican Hill Retreat  House, it was meant to provide peace and tranquility for its residents. \n\n"
    ...
    lightImagePath: "assets/ghost/diplomat_light.png",
    darkImagePath: "assets/ghost/diplomat_dark.png",
    lightNamePath: "assets/ghost/diplomatname_light.png",
    darkNamePath: "assets/ghost/diplomatname_dark.png",
    lightPageCountPath: "assets/ghost/Gpagecount2_light.png",
    darkPageCountPath: "assets/ghost/Gpagecount2_dark.png",
    sources: [
  ...
  Ghost(
    ...
    description: "The Manila Film Center is a building located at the southwest end of the Cultural Center of the Philippines Complex in Pasay, Philippines. The structure was designed by architect Froilan Hong and served as the main theater for the First Manila International Film Festival[2] (MIFF) January 18-29, 1982. \n\n"
    ...
    lightImagePath: "assets/ghost/MNLfilm_light.png",
    darkImagePath: "assets/ghost/MNLfilm_dark.png",
    lightNamePath: "assets/ghost/MNLfilmname_light.png",
    darkNamePath: "assets/ghost/MNLfilmname_dark.png",
    lightPageCountPath: "assets/ghost/Gpagecount3_light.png",
    darkPageCountPath: "assets/ghost/Gpagecount3_dark.png",
    sources: [
  ...
  Ghost(
    ...
    description: "Clark Air Base Hospital was a significant military hospital in Angeles, Pampanga, Philippines, serving American and Filipino soldiers during World War II, the Vietnam War, and beyond. It was originally a small dispensary for American soldiers and grew into a key medical facility. \n\n"
    ...
    lightImagePath: "assets/ghost/clarkhosp_light.png",
    darkImagePath: "assets/ghost/clarkhosp_dark.png",
    lightNamePath: "assets/ghost/clarkhospname_light.png",
    darkNamePath: "assets/ghost/clarkhospname_dark.png",
    lightPageCountPath: "assets/ghost/Gpagecount4_light.png",
    darkPageCountPath: "assets/ghost/Gpagecount4_dark.png",
    sources: [
      "https://www.flickr.com/photos/28006802@N07/8644515537",
  ...
  Ghost(
    ...
    description: "The Paco Park (originally named as Cementerio General de Dilao) is a recreational garden and was once Manila's municipal cemetery built by the Dominicans during the Spanish colonial period. \n\n"
    ...
    lightImagePath: "assets/ghost/pacocem_light.png",
    darkImagePath: "assets/ghost/pacocem_dark.png",
    lightNamePath: "assets/ghost/pacocemname_light.png",
    darkNamePath: "assets/ghost/pacocemname_dark.png",
    lightPageCountPath: "assets/ghost/Gpagecount5_light.png",
    darkPageCountPath: "assets/ghost/Gpagecount5_dark.png",
    sources: [
